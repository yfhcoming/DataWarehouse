...
class MovieExtract:
    ...
    def __init__(
            self,
            page_dir_path='./dataProcess/data/webPages',
            uf_path='./dataProcess/data/UFMap/component_mapping.pickle',
            labels_path='./dataProcess/data/rawData/labels.csv',
            target_path='./dataProcess/data/rawData/movies.csv',
    ):
        """
        初始化
        """
        ...
        for root_path, _, file_names in os.walk(self.page_dir_path):
            for index, file_name in enumerate(file_names):
                ...
                if isPrimeVideo:
                    ...
                    node_list = html.xpath('/html/body/div[1]/div[2]/div[4]/div/div/div[2]/div[2]/div/div[3]/div/div')[0].xpath('dl')
